...
//フロントエンド
const Frontend = [
  { src: HtmlIcon, alt: "HTML", level: 4, description: "独学で学習。基本的なことはできる。" },
  { src: CssIcon, alt: "CSS", level: 4, description: "独学で学習。基本的なことはできる。" },
...
//バックエンド
const Backend = [
  { src: PHPicon, alt: "PHP", level: 3, description: "独学で学習。基本的なことはできる。" },
  { src: LaravelIcon, alt: "Laravel", level: 3, description: "独学で学習。PHPのフレームワークで基本的なことはできる。" },
  { src: NodeIcon, alt: "Node", level: 1, description: "独学で現在学習中。サーバーサイドでJavaScriptを使うためのプラットフォームであまり理解ができていない。" },
  { src: MysqlIcon, alt: "Mysql", level: 4, description: "独学で学習。基礎的な操作ができる。" },
  { src: SsmsIcon, alt: "SSMS", level: 4, description: "独学で学習。基礎的な操作ができる。" },
];

//インフラ
const Infra = [
  { src: AWSIcon, alt: "AWS", level: 1, description: "クラウドサービス。あまり理解ができていない。" },
  { src: DockerIcon, alt: "Docker", level: 1, description: "コンテナ仮想化ツール。少しだけ操作ができる程度。" },
  { src: LinuxIcon, alt: "Linux", level: 1, description: "基本的なコマンド操作ができる程度。" },
];

const Tool = [
  { src: GitIcon, alt: "Git", level: 3, description: "バージョン管理ツール。基本的なコマンド操作ができる程度。" },
  { src: GitHubIcon, alt: "GitHub", level: 3, description: "バージョン管理ツール。基本的なコマンド操作ができる程度。" },
  { src: NPMIcon, alt: "npm", level: 1, description: "Node.jsのパッケージ管理システム。簡単なコマンド操作ができる程度。" },
];

//コンテンツ管理システム
const CMS = [{ src: WPIcon, alt: "WordPress", level: 1, description: "Webサイトやブログを簡単に作成・管理できるコンテンツ管理システム。あまり理解ができていない。" }];

//デザイン
const Design = [
  { src: AiIcon, alt: "Illustrator", level: 2, description: "テキストと画像を組み合わせたレイアウトの作成ができる。簡単な操作ができる程度" },
  { src: PsIcon, alt: "Photoshop", level: 1, description: "画像編集ソフト。あまり理解ができていない。" },
  { src: XdIcon, alt: "Xd", level: 2, description: "UI/UXデザインに特化したツール。簡単な操作ができる程度。" },
];
...
export { Frontend, Backend, Infra, Tool, CMS, Design, Profile, SNS, Others, Skills, Profiloes };
